...
namespace cartservice.cartstore
{
    public class RedisCartStore : ICartStore
    {
        ...
        public async Task AddItemAsync(string userId, string productId, int quantity)
        {
            ...
            {
                activity.SetTag("PodName", Environment.GetEnvironmentVariable("POD_NAME"));
                activity.SetTag("NodeName", Environment.GetEnvironmentVariable("NODE_NAME"));
            }
            ActivityContext spanContext = activity.Context;
            ActivityTraceId traceId = spanContext.TraceId;
            ActivitySpanId spanId = spanContext.SpanId;
            Console.WriteLine($"TraceID: {traceId} SpanID: {spanId} AddItemAsync called with userId={userId}, productId={productId}, quantity={quantity}");
        ...
        public async Task EmptyCartAsync(string userId)
        {
            ...
            ActivityTraceId traceId = spanContext.TraceId;
            ActivitySpanId spanId = spanContext.SpanId;
            Console.WriteLine($"TraceID: {traceId} SpanID: {spanId} EmptyCartAsync called with userId={userId}");
        ...
        public async Task<Hipstershop.Cart> GetCartAsync(string userId)
        {
            ...
            ActivityTraceId traceId = spanContext.TraceId;
            ActivitySpanId spanId = spanContext.SpanId;
            Console.WriteLine($"TraceID: {traceId} SpanID: {spanId} GetCartAsync called with userId={userId}");
